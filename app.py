...
def load_ltc_file(file_path):
    ...
    try:
        # Check if it's just a filename (from web browser) or full path
...
def main():
    ...
    try:
        ...
        if sys.platform in ['win32', 'win64']:
            eel.start('index.html', mode='edge', port=8001)
        else:
            eel.start('index.html', mode='default', port=8001)
